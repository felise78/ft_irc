...
#define ERR_NEEDUSERNAME(hostname) (":" + hostname + " 451 USER :Need username to register\r\n")
#define ERR_NEEDNICKNAME(hostname) (":" + hostname + " 451 NICK :Need nickname to register\r\n")
#define ERR_NEEDPASSWORD(hostname) (":" + hostname + " 451 PASS :Need password to register\r\n")
